...
public class App {
  ...
  public static void main(String[] args) throws IOException, UnsupportedVersionException {
    ...
    do {
      ...
      System.out.println(" 2. Comm Test");
      ...
      switch (option) {
        ...
        case 1:
          ...
          tcpClient.send(
              new ProtocolMessage(MessageCode.AUTH, new String(username + "\0" + password + "\0")));
          ...
          if (response.getCode() == MessageCode.ACK) {
            ...
            System.out.println("Login failed: " + response.getStringifiedPayload());
          }
          break;

        // comm test
        case 2:
          tcpClient.send(new ProtocolMessage(MessageCode.COMMTEST));
