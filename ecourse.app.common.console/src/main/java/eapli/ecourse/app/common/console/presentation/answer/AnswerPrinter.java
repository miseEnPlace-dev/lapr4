...
public class AnswerPrinter implements Visitor<AnswerDTO> {
  public String header() {
    return String.format("#  %-14s%-15s%-30s%-10s%-10s%-16s", "Student No.", "Name", "Exam", "Course", "Score", "Date");
  }
  ...
  public void visit(final AnswerDTO visitee) {
    ...
    printer.addColumn(visitee.getCourse(), 10);
    printer.addColumn(visitee.getScore() == null ? "N/a" : visitee.getScore(), 10);
