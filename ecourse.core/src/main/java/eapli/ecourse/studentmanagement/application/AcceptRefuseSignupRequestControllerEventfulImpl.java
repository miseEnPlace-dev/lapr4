 ...
 * only modify one aggregate, and (2) notify other parts of the system to react
 * accordingly. For an
 * alternative transactional approach see
 ...
 * and executed in
 * separate transactions (and eventually threads) according to the publishing of
 * events. The first
 ...
 *           participant SignupAcceptedWatchDog create SignupAcceptedWatchDog
 *           App ->
 *           SignupAcceptedWatchDog : new App -> dispatcher:
 *           subscribe(signupWatchDog) create
 *           NewUserRegisteredFromSignupWatchDog App ->
 *           NewUserRegisteredFromSignupWatchDog:new App
 *           -> dispatcher: subscribe(newUserWatchDog)
 *
 * @enduml --> <!--
 *
 * @startuml seq-use-case.svg title Full Use case execution participant
 *           dispatcher participant UI
 *           participant AcceptRefuseSignupRequestController participant
 *           SignupRepository
 *           participant SignupAcceptedEvent participant SignupAcceptedWatchDog
 *           participant
 *           AddUserOnSignupAcceptedController participant UserRepository
 *           participant
 ...
 *           SignupRepository:save create SignupAcceptedEvent
 *           AcceptRefuseSignupRequestController ->
 *           "SignupAcceptedEvent":new AcceptRefuseSignupRequestController ->
 *           dispatcher:publish
 *           deactivate AcceptRefuseSignupRequestController end group Register
 *           system user
 *           dispatcher -> SignupAcceptedWatchDog: onEvent activate
 *           SignupAcceptedWatchDog
 ...
 * @enduml --> <!--
 *
 * @startuml seq-accept-sign-up.svg title Accept the Signup participant
 *           dispatcher participant UI
 *           participant AcceptRefuseSignupRequestController participant
 *           SignupRepository
 ...
 * @enduml --> <!--
 *
 * @startuml seq-register-system-user.svg title Register System User participant
 *           dispatcher
 *           participant SignupAcceptedWatchDog participant
 *           AddUserOnSignupAcceptedController
 *           participant UserRepository participant
 *           NewUserRegisteredFromSignupEvent group Register
 *           system user dispatcher -> SignupAcceptedWatchDog: onEvent activate
 *           SignupAcceptedWatchDog SignupAcceptedWatchDog ->
 *           AddUserOnSignupAcceptedController:addUser activate
 *           AddUserOnSignupAcceptedController
 ...
 *           NewUserRegisteredFromSignupEvent:new
 *           AddUserOnSignupAcceptedController ->
 *           dispatcher:publish deactivate AddUserOnSignupAcceptedController
 *           deactivate
