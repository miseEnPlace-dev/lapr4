 ...
 * <p>
 * It is published by an {@link eapli.framework.infrastructure.eventpubsub.EventPublisher}, in this
 * case inside
 * {@link eapli.ecourse.clientusermanagement.application.AcceptRefuseSignupRequestControllerEventfulImpl}.
 * <p>
 * Afterwards it is processed by any {@link eapli.framework.infrastructure.eventpubsub.EventHandler}
