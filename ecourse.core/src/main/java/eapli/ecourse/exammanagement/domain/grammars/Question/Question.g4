...
multiple_choice_question:
	'multiple-choice' EOI body feedback? (
		START_CORRECT_ANSWERS_SECTION multiple_choice_correct_answer+ END_CORRECT_ANSWERS_SECTION EOI
		| multiple_choice_correct_answer
	) START_OPTIONS_SECTION option+ END_OPTIONS_SECTION EOI;

short_answer_question:
	'short-answer' EOI body feedback? START_CORRECT_ANSWERS_SECTION short_answer_correct_answer+
		END_CORRECT_ANSWERS_SECTION EOI;

true_false_question:
	'true-false' EOI body feedback? CORRECT_ANSWER (
		'true'
		| 'false'
	) EOI;

matching_question:
	'matching' EOI body feedback? START_CORRECT_ANSWERS_SECTION matching_correct_answer+
...
matching_correct_answer: CORRECT_ANSWER NUMBER ' ' NUMBER EOI;
