...
public class ListFutureExamsController {
  ...
  public ListFutureExamsController(AuthorizationService authz, ExamRepository examRepository,
      EnrolmentRepository enrolmentRepository, StudentRepository studentRepository, CourseRepository courseRepository) {
    this.authz = authz;
