...
public class ScheduleAvailabilityService {
  ...
  public ScheduleAvailabilityService(ClassRepository classRepository,
  ...
  private boolean isStudentAvailable(SystemUser user, Time time, Duration duration) {
    ...
    for (Enrolment enrolment : enrolments) {
      ...
      Iterable<Class> classes = classRepository.findAllByCourseCode(course.code());
  ...
  private boolean isAvailableFromClasses(Iterable<Class> classes, Time time, Duration duration) {
    for (Class c : classes) {
  ...
  private boolean isAvailable(Class c, Time scheduleStart, Duration duration) {
