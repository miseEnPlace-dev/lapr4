...
// controller.createCourse(null, null, null, 0, 0, null));
// }
...
// assertThrows(IllegalArgumentException.class, () ->
// controller.createCourse("", "", "", 0, 0, null));
// }

// @Test
// public void ensureItsNotPossibleToCreateCourseWithNegativeLimits() {
// assertThrows(IllegalArgumentException.class, () ->
// controller.createCourse("1234", "dummy", "dummy", -1, -1, null));
// }
...
// assertThrows(IllegalArgumentException.class, () ->
// controller.createCourse("1234", "dummy", "dummy", 10, 20,
// getDummyTeacherDTO()));
// }
