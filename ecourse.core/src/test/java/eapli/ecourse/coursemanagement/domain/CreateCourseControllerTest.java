...
public class CreateCourseControllerTest {
  ...
  public void ensureItsPossibleToCreateCourse() {
    ...
    Course course = controller.createCourse(CourseCode.valueOf("1234"), CourseTitle.valueOf("dummy"),
  ...
  public void ensureItsPossibleToCreateCourseWithOpenState() {
    ...
    assertEquals(new CourseEnrolmentState(EnrolmentState.OPEN), course.enrolmentState());
  }
  ...
  public void ensureItsPossibleToCreateCourseWithClosedState() {
    ...
    assertEquals(new CourseEnrolmentState(EnrolmentState.CLOSED), course.enrolmentState());
