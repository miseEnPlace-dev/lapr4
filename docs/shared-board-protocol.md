...
| 5    | `GET_BOARDS`     | Shared board application request. Used to get boards which the user has permission to access.                                                                                                                                                                                                          |
| 6    | `GET_OWN_BOARDS` | Shared board application request. Used to get boards which the user owns.                                                                                                                                                                                                                              |
| 7    | `SHARE_BOARD`    | Shared board application request. Used to modify another user's permission to a board.                                                                                                                                                                                                                 |
