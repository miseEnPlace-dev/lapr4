...
| 8    | `GET_WRITABLE_BOARDS`  | Used to get boards where the authenticated user has write permission.                                                                                                                                                                                                                                  |
| 9    | `GET_BOARD`            | Used to get a board by specifying the desired id in the payload.                                                                                                                                                                                                                                       |
| 10   | `GET_USER_PERMISSIONS` | Used to retrieve the permissions a specific user has to a certain board which the authenticated user owns.                                                                                                                                                                                             |
| 11   | `GET_BOARD_HISTORY`    | Used to get the history of a specific board.                                                                                                                                                                                                                                                           |
| 12   | `SHARE_BOARD`          | Used to modify another user's permission to a board.                                                                                                                                                                                                                                                   |
| 13   | `ARCHIVE_BOARD`        | Used to archive a user's board.                                                                                                                                                                                                                                                                        |
| 14   | `CREATE_POSTIT`        | Used to create a post-it in a specific board.                                                                                                                                                                                                                                                          |
| 15   | `EDIT_POSTIT`          | Used to edit a post-it.                                                                                                                                                                                                                                                                                |
| 16   | `UNDO_POSTIT`          | Used to undo the last change in a post-it.                                                                                                                                                                                                                                                             |
| 17   | `GET_BOARD_POSTITS`    | Used to get the post-its of a board.                                                                                                                                                                                                                                                                   |
