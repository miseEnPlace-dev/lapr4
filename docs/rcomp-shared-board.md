...
| 19   | `DELETE_POSTIT`         | Used to delete a post-it. The authenticated user must be owner of the post-it and have write permission to the board.                                                                                                                                                                                  |
| 20   | `IS_CELL_AVAILABLE`     | Used to check if a certain cell does not have a post-it in it. The authenticated user must have at least read permission to the board.                                                                                                                                                                 |
| 21   | `GET_ONLINE_COUNT`      | Used to get the number of clients currently connected to the server.                                                                                                                                                                                                                                   |
