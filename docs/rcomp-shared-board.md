...
| 16   | `UNDO_POSTIT`          | Used to undo the last change in a post-it. The authenticated user must be owner of the post-it or the owner of the board.                                                                                                                                                                              |
...
| 18   | `GET_ONLINE_COUNT`     | Used to get the number of clients currently connected to the server.                                                                                                                                                                                                                                   |
