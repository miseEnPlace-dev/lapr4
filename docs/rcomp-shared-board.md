...
| 5    | `SPLIT`                 | Indicates the original payload has exceeded the maximum size supported by the protocol. The payload of this request indicates the number of the bytes and the following messages together make the full payload.                                                                                       |
